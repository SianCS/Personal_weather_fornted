        ...
        <div className="card bg-base-100/50 backdrop-blur-sm shadow-xl w-full">
            <div className="card-body items-center text-center">
                <div className="card-actions justify-end w-full absolute top-2 right-2">
                     <button className="btn btn-primary btn-circle " onClick={onFavoriteClick} title={isFavorited ? "ลบออกจากรายการโปรด" : "เพิ่มเป็นรายการโปรด"}>
               ...
               <div className="flex justify-around w-full">
                    ...
                    {/* ✨ HIGHLIGHT: เพิ่มไอคอน 💧 เข้าไปในส่วนแสดงโอกาสเกิดฝน */}
                    {weather.chanceOfRain > 0 && (
                        <div className="text-center">
                            <p className="font-semibold opacity-70">โอกาสเกิดฝน</p>
